...
STDMETHODIMP
dxil_debug_info::DxcPixConstType::GetName(_Outptr_result_z_ BSTR *Name) {
...
STDMETHODIMP
dxil_debug_info::DxcPixTypedefType::GetName(_Outptr_result_z_ BSTR *Name) {
...
STDMETHODIMP
dxil_debug_info::DxcPixScalarType::GetName(_Outptr_result_z_ BSTR *Name) {
  *Name = CComBSTR(CA2W(m_pType->getName().data())).Detach();
  return S_OK;
}
...
STDMETHODIMP
dxil_debug_info::DxcPixArrayType::GetName(_Outptr_result_z_ BSTR *Name) {
...
STDMETHODIMP
dxil_debug_info::DxcPixStructType::GetName(_Outptr_result_z_ BSTR *Name) {
...
STDMETHODIMP dxil_debug_info::DxcPixStructType::GetFieldByIndex(
    DWORD dwIndex, _Outptr_result_z_ IDxcPixStructField **ppField) {
  *ppField = nullptr;
...
STDMETHODIMP dxil_debug_info::DxcPixStructType::GetFieldByName(
    _In_ LPCWSTR lpName, _Outptr_result_z_ IDxcPixStructField **ppField) {
...
STDMETHODIMP
dxil_debug_info::DxcPixStructField::GetName(_Outptr_result_z_ BSTR *Name) {
