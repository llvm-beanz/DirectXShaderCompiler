...
public:
  ...
  STDMETHODIMP GetSizeInBits(_Outptr_result_z_ DWORD *pSizeInBits) override;

  STDMETHODIMP UnAlias(_Outptr_result_z_ IDxcPixType **ppType) override;
};
...
public:
  ...
  STDMETHODIMP GetBaseType(_COM_Outptr_ IDxcPixType **ppType) override;
};
...
public:
  ...
  STDMETHODIMP GetOffsetInBits(_Outptr_result_z_ DWORD *pOffsetInBits) override;
};
} // namespace dxil_debug_info
