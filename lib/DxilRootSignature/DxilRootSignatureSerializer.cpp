...
void SerializeRootSignatureTemplate(
    _In_ const T_ROOT_SIGNATURE_DESC *pRootSignature,
    DxilRootSignatureVersion DescVersion, _COM_Outptr_ IDxcBlob **ppBlob,
    DiagnosticPrinter &DiagPrinter, _In_ bool bAllowReservedRegisterSpace) {
...
void DeserializeRootSignatureTemplate(
    ...
    _In_ uint32_t SrcDataSizeInBytes, DxilRootSignatureVersion DescVersion,
...
_Use_decl_annotations_ void DeserializeRootSignature(
