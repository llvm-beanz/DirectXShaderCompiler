...
HRESULT CreateMSFileSystemForIface(
...
/// resources.</summary>
HRESULT CreateMSFileSystemBlocked(
    _COM_Outptr_ ::llvm::sys::fs::MSFileSystem **pResult) throw();
...
static HRESULT CopyStatStg(_In_ const STATSTG *statStg,
...
static void ClearStatStg(_Inout_ STATSTG *statStg) {
...
private:
  ...
  HRESULT AddFindHandle(_In_ IEnumSTATSTG *enumStatStg,
                        _Out_ HANDLE *pResult) throw();
  HRESULT AddFileHandle(_In_ IUnknown *storage, _In_ IStream *stream,
                        _Out_ HANDLE *pResult) throw();
  HRESULT AddMappingHandle(_In_ IUnknown *mapping,
                           _Out_ HANDLE *pResult) throw();
  HRESULT AddMappingView(_In_ ID3D10Blob *blob) throw();
  HRESULT EnsureFDAvailable(int fd);
  HANDLE GetHandleForFD(int fd) throw();
  void GetFindHandle(HANDLE findHandle,
                     _Outptr_ IEnumSTATSTG **enumStatStg) throw();
...
public:
  ...
  virtual BOOL ReadFile(_In_ HANDLE hFile, _Out_ LPVOID lpBuffer,
...
_Use_decl_annotations_ HRESULT MSFileSystemForIface::AddMappingHandle(
    IUnknown *mapping, HANDLE *pResult) throw() {
...
MSFileSystemForIface::AddMappingView(ID3D10Blob *blob) throw() {
...
_Use_decl_annotations_ HRESULT MSFileSystemForIface::AddFindHandle(
    IEnumSTATSTG *enumStatStg, HANDLE *pResult) throw() {
...
_Use_decl_annotations_ HRESULT MSFileSystemForIface::AddFileHandle(
    IUnknown *storage, IStream *stream, HANDLE *pResult) throw() {
...
MSFileSystemForIface::RemoveMappingView(LPCVOID address) throw() {
...
_Use_decl_annotations_ void
MSFileSystemForIface::GetFindHandle(HANDLE findHandle,
...
_Use_decl_annotations_ void
MSFileSystemForIface::GetHandleMapping(HANDLE mapping,
                                       _Outptr_ IUnknown **pResult) throw() {
  DXASSERT_NOMSG(mapping != nullptr);
  DXASSERT_NOMSG(pResult != nullptr);
...
_Use_decl_annotations_ void
MSFileSystemForIface::GetHandleStorage(HANDLE fileHandle,
                                       _Outptr_ IUnknown **pResult) throw() {
  DXASSERT_NOMSG(fileHandle != nullptr);
  DXASSERT_NOMSG(pResult != nullptr);
...
_Use_decl_annotations_ void
MSFileSystemForIface::GetHandleStream(HANDLE fileHandle,
                                      _Outptr_ IStream **pResult) throw() {
  DXASSERT_NOMSG(fileHandle != nullptr);
  DXASSERT_NOMSG(pResult != nullptr);
...
_Use_decl_annotations_ HANDLE MSFileSystemForIface::FindFirstFileW(
...
_Use_decl_annotations_ BOOL MSFileSystemForIface::FindNextFileW(
...
_Use_decl_annotations_ HANDLE MSFileSystemForIface::CreateFileW(
...
_Use_decl_annotations_ BOOL MSFileSystemForIface::SetFileTime(
...
_Use_decl_annotations_ BOOL MSFileSystemForIface::GetFileInformationByHandle(
...
MSFileSystemForIface::GetFileType(HANDLE hFile) throw() {
  HRESULT hr = S_OK;
  CComPtr<IUnknown> storage;
  DWORD fileType;
...
_Use_decl_annotations_ BOOL MSFileSystemForIface::CreateHardLinkW(
    LPCWSTR lpFileName, LPCWSTR lpExistingFileName) throw() {
  SetLastError(ERROR_FUNCTION_NOT_CALLED);
  return FALSE;
}

_Use_decl_annotations_ BOOL MSFileSystemForIface::MoveFileExW(
...
_Use_decl_annotations_ DWORD
MSFileSystemForIface::GetFileAttributesW(LPCWSTR lpFileName) throw() {
  HRESULT hr = S_OK;
  DWORD attributes;
...
MSFileSystemForIface::CloseHandle(HANDLE hObject) throw() {
  this->CloseInternalHandle(hObject);
  return TRUE;
}

_Use_decl_annotations_ BOOL
MSFileSystemForIface::DeleteFileW(LPCWSTR lpFileName) throw() {
  SetLastError(ERROR_FUNCTION_NOT_CALLED);
  return FALSE;
}

_Use_decl_annotations_ BOOL
MSFileSystemForIface::RemoveDirectoryW(LPCWSTR lpFileName) throw() {
  SetLastError(ERROR_FUNCTION_NOT_CALLED);
  return FALSE;
}

_Use_decl_annotations_ BOOL
MSFileSystemForIface::CreateDirectoryW(LPCWSTR lpPathName) throw() {
  SetLastError(ERROR_FUNCTION_NOT_CALLED);
  return FALSE;
}

_Use_decl_annotations_ DWORD MSFileSystemForIface::GetCurrentDirectoryW(
...
_Use_decl_annotations_ DWORD MSFileSystemForIface::GetMainModuleFileNameW(
...
_Use_decl_annotations_ DWORD MSFileSystemForIface::GetTempPathW(
    DWORD nBufferLength, LPWSTR lpBuffer) throw() {
  DWORD written = 0;
  HRESULT hr = S_OK;
...
_Use_decl_annotations_ BOOLEAN MSFileSystemForIface::CreateSymbolicLinkW(
...
_Use_decl_annotations_ BOOL MSFileSystemForIface::ReadFile(
...
_Use_decl_annotations_ HANDLE MSFileSystemForIface::CreateFileMappingW(
...
_Use_decl_annotations_ LPVOID MSFileSystemForIface::MapViewOfFile(
...
_Use_decl_annotations_ BOOL
MSFileSystemForIface::UnmapViewOfFile(LPCVOID lpBaseAddress) throw() {
...
MSFileSystemForIface::resize_file(LPCWSTR path, uint64_t size) throw() {
  return EBADF;
}

_Use_decl_annotations_ int
MSFileSystemForIface::Read(int fd, void *buffer, unsigned int count) throw() {
  HRESULT hr = S_OK;
  CComPtr<IStream> stream;
  ULONG cbRead = 0;
  if (FAILED(EnsureFDAvailable(fd))) {
...
_Use_decl_annotations_ int
MSFileSystemForIface::Write(int fd, const void *buffer,
...
public:
  ...
  virtual BOOL FindNextFileW(_In_ HANDLE,
                             _Out_ LPWIN32_FIND_DATAW) throw() override {
  ...
  _Success_(return != 0 && return < nBufferLength) virtual DWORD
      GetCurrentDirectoryW(_In_ DWORD nBufferLength,
                           _Out_writes_to_opt_(nBufferLength, return +1)
                               LPWSTR lpBuffer) throw() override;
  virtual DWORD GetMainModuleFileNameW(__out_ecount_part(nSize, return +1)
                                           LPWSTR lpFilename,
                                       DWORD nSize) throw() override;
  _Success_(return != 0 && return < nBufferLength) virtual DWORD
  ...
  virtual BOOL
  ReadFile(_In_ HANDLE hFile, _Out_ LPVOID lpBuffer,
           _In_ DWORD nNumberOfBytesToRead,
           _Out_opt_ LPDWORD lpNumberOfBytesRead) throw() override {
    return MSFileSystemBlockedErrWin32();
  }
...
_Use_decl_annotations_ DWORD MSFileSystemBlocked::GetCurrentDirectoryW(
    DWORD nBufferLength, LPWSTR lpBuffer) throw() {
  if (nBufferLength > 1) {
    lpBuffer[0] = L'.';
    lpBuffer[1] = L'\0';
...
_Use_decl_annotations_ DWORD MSFileSystemBlocked::GetMainModuleFileNameW(
    LPWSTR lpFilename, DWORD nSize) throw() {
  SetLastError(NO_ERROR);
  return 0;
}
...
_Use_decl_annotations_ HRESULT CreateMSFileSystemForIface(
    IUnknown *pService, ::llvm::sys::fs::MSFileSystem **pResult) throw() {
