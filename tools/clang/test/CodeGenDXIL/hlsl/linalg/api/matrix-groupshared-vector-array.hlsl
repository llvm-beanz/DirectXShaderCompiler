...
// the matrix component type, in addition to arrays of scalars.
...
// CHECK-SAME: float addrspace(3)* getelementptr inbounds ([64 x <4 x float>],
// CHECK-SAME: [64 x <4 x float>] addrspace(3)* @"\01?SharedVecArr@@3PAV?$vector@M$03@@A", i32 0, i32 0, i32 0),
...
// CHECK-SAME: i32 addrspace(3)* getelementptr inbounds ([64 x <2 x i32>],
// CHECK-SAME: [64 x <2 x i32>] addrspace(3)* @"\01?PackedVecArr@@3PAV?$vector@$ui8_4pk@$01@@A", i32 0, i32 0, i32 0),
// CHECK-SAME: i32 0, i32 16, i32 1)  ; LinAlgMatrixLoadFromMemory(memory,offset,stride,layout)
