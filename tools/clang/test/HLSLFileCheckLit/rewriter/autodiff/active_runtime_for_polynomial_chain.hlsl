...
// A signed sum of mixed monomials contributes both analytic partials to the
// changing local Jacobian reconstructed from primal tapes.

// CHECK: x.value = (((x.value * x.value) * y.value) + ((x.value * y.value) * y.value));
// CHECK: __dxc_ad_loop_0_state_1_adjoint += (__dxc_ad_loop_0_primal_tape[iteration] * __dxc_ad_loop_0_primal_tape[iteration] + 2 * __dxc_ad_loop_0_primal_tape[iteration] * __dxc_ad_loop_1_primal_tape[iteration]) * __dxc_ad_loop_0_state_0_adjoint;
// CHECK: __dxc_ad_loop_0_state_0_adjoint *= (2 * __dxc_ad_loop_0_primal_tape[iteration] * __dxc_ad_loop_1_primal_tape[iteration] + __dxc_ad_loop_1_primal_tape[iteration] * __dxc_ad_loop_1_primal_tape[iteration]);
