...
// A target-linear term contributes only to the target partial of an assignment
// product edge; the peer partial remains the scaled taped target.
...
// CHECK: __dxc_ad_loop_0_state_0_adjoint *= (scale * __dxc_ad_loop_1_primal_tape[iteration] + slope);
