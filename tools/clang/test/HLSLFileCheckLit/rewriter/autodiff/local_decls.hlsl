...
//
//
// This test only checks the rewriter output. Backward local declarations are
// still typed as Variable<T>, while their initializers are expression-template
// types, so this case cannot compile yet.
...
// CHECK: return compute_gradients(context, b);
