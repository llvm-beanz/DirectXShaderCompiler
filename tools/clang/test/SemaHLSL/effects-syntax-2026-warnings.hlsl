...
Texture2D stateBlock { Texture = tex; }; // expected-warning {{effect state block ignored - effect syntax is deprecated and will be removed in HLSL 2026. To use braces as an initializer use them with equal signs.}}
