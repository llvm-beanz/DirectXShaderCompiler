...
// This test locks down that HLSL's initializer-list element-count
// diagnostics ("too few/too many elements in vector initialization") are
// worded and triggered identically whether the offending flat list of
// initializer elements was written by hand or produced by expanding a
// variadic template pack -- i.e. the scalarizing initializer-list logic
// does not special-case (and does not need to special-case) packs.
